...
console.log(require.resolve('pretty-format'));
    ...
    <div className={getClassName('App')}>
      ...
      <main className={getClassName('App__main')}>
        <BpkInput
          ...
          name="date"
          value={(selectionConfig.selectionConfiguration.date || '').toString()}
        ...
        <BpkCalendar
          ...
          selectionConfiguration={selectionConfig.selectionConfiguration}
